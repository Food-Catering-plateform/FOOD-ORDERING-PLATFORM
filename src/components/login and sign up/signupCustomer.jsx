import React, { useState } from "react"; // I added useState so I can store what the user types
import "./style-signupCustomer.css";
import Register from "../services/Register"; // I added this to use my teammate's signup logic
